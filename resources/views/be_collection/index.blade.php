                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                ...
                                @foreach($collection as $collection)
                                        ...
                                        <tr>
                                            <td> {{$collection->template_id}}</td>
                                            <td> {{$collection->user_id}}</td>

                                            <td>
                                                <a href="/collection/{{$collection->id}}/edit" class = "btn btn-warning btn-sm">Edit</a>
                                                <a href="/collection/{{$collection->id}}/delete" class= "btn btn-danger btn-sm" onclick="return confirm('konfirm untuk hapus data')">Hapus</a>
                                            </td>
                                        </tr>
